...
const Hero = ({ t }) => {
  ...
  return (
    <div className="hero">
      <div className="hero-section1" ref={ref}>
        <div className={`hero-section1-right fade-up2 ${inView ? "show" : ""}`}>
          <div className="hero-section1-right-top">
            <div className="hero-section1-right-top-title">
              <h2 className={`staggered-entry1 ${inView ? "show3" : ""}`}>
                {t("hero.title1")}
              </h2>
              <h2 className={`staggered-entry2 ${inView ? "show3" : ""}`}>
                {t("hero.title2")}
              </h2>
              <h2
                className={`title3 staggered-entry3 ${inView ? "show3" : ""}`}
              >
                {t("hero.title3")}
              </h2>
            </div>
      ...
      <div className="hero-section2" ref={ref2}>
        <div
          className={`hero-section2-right fade-up2 ${inView2 ? "show" : ""}`}
        >
          <img
      ...
      <div className="hero-section3" ref={ref3}>
        <div
          className={`hero-section3-right fade-up2 ${inView3 ? "show" : ""}`}
        >
          <h2>{t("hero.title5")}</h2>
          <p>{t("hero.text7")}</p>
          <Button
