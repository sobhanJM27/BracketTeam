    ...
    <div className="blog-section">
      ...
      <div className="blog-section-boxes">
        {data.similar?.map((item) => {
          return (
            <div key={item.similar?._id} className="blog-section-box">
              <div className="blog-section-box-right">
                ...
                <div className="blog-section-box-middle">
                  <span className="blog-section-box-middle-text1">
                    {formatDistanceToNow(new Date(item.similar?.createdAt), {
                      addSuffix: true,
                      locale: lang === 'fa' ? faIR : enZA,
                    })}
                  </span>
                  <span className="blog-section-box-middle-text2">
                    {item.similar?.fa.title}
                  </span>
                </div>
              </div>
